# -*- coding: utf-8 -*-
"""
Created on Fri Mar 30 14:50:06 2018
...
def myLoader(datasetFile,trainSize,crossSize,testSize):
    ''' A function that takes datasetFileName , trainDataSize ,crossValidationSize , testDataSize and bifurcate the data set into 
     trainData , crossValidationData and testData. The TrainData,CrossValidationData and TestData contains ``(input,output)`` pairs.'''
